      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <form action="includes/signup.inc.php" method="post" class="mb-md-5 mt-md-4 pb-5">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                  ...
                  <?php 
                    ...
                    if ($_GET["error"] == "userExist") {
                      echo"<p class='mb-0'> this user already exists </p>";
                    }
                  ?>
                </div>
              <?php } ?>
              ...
              <button name="submit" class="btn btn-outline-light btn-lg px-5" type="submit">Sign up</button>
